...
Private Sub Form_Unload(Cancel As Integer)
    'if picture modified, ask for a save
    If blnModified Then
        If MsgBox("Save Before Exit?", vbInformation + vbYesNo, "Exit") = vbYes Then
    ...
    With mudtTool
        ...
        ElseIf .Circle Then
            With mudtCircle
                ...
                .mintCircleX2 = x
                .mintCircleY2 = y
                PenCul& = picMain.BackColor Xor QBColor(0)
                picMain.DrawMode = 7    'to enable live drawing
                .mdblCircleR = distancePoints(.mintCircleX1, .mintCircleX2, _
                    .mintCircleY1, .mintCircleY2)
                picMain.Circle (.mintCircleX1, .mintCircleY1), .mdblCircleR, PenCul&
            End With
        ElseIf .Square Then
            With mudtSquare
                .mintSquareX1 = x
        ...
        With mudtTool
            ...
            ElseIf .Line Then
                With mudtLine
                    PenCul& = picMain.BackColor Xor QBColor(0)
                    picMain.DrawMode = 7    'to enable live drawing
                    picMain.Line (.mintLineX1, .mintLineY1)-(.mintLineX2, .mintLineY2), PenCul&
            ...
            ElseIf .Square Then
                With mudtSquare
                    PenCul& = picMain.BackColor Xor QBColor(0)
                        picMain.DrawMode = 7    'to enable live drawing
                        picMain.Line (.mintSquareX1, .mintSquareY1)-(.mintSquareX2, .mintSquareY2), PenCul&, B
